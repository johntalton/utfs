...
describe('UTFS', () => {
	...
	describe('load', () => {
		...
		it('should load registered file with gaps in listing', async () => {
			const buffer = Uint8Array.from([
				0x84, 0x19, 0x01, 0x00, 0x00, 0x00,
				0x00, 0x00, 0x03, 0x00, 0x00, 0x00,
				0x74, 0x65, 0x73, 0x74, 0x2d, 0x31,
				0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
				  42,   77,    0,
				0x84, 0x19, 0x01, 0x00, 0x00, 0x01,
	...
	describe('save', () => {
		...
		it('should save single file', async () => {
			...
			assert.equal(target8[0], 0x84)
			assert.equal(target8[1], 0x19)
